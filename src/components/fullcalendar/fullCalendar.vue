...
<!--        <strong class="week" v-for='dayIndex in 7'>周{{weekday[dayIndex-1]}}</strong>
 -->      </div>
  ...
  export default {
    ...
    filters: {
      localeWeekDay (weekday, firstDay, locale) {
        ...
        console.log(locale)
        console.log(localMoment.localeData()) 
        console.log(localMoment.localeData().weekdaysShort())
        /*获取语言数据
        ...
        return week[(weekday + firstDay) % 7];
      }
    }
  }
